...
| Metric | reads_from_vega::primary | reads_from_vega::hap1 | reads_from_vega::hap2 | hifiasm_centrifuge_reads::primary | hifiasm_centrifuge_reads::hap1 | hifiasm_centrifuge_reads::hap2 |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
